...
function ChangePassword(){
    ...
    const applyChangePassword = async ()=>{
        ...
        if(Object.keys(errors).length===0){
            fetch("https://expense-tracker-d2dz.onrender.com/auth/changePassword", { method: "PUT", headers: { 'Content-Type': "application/json" }, body: JSON.stringify({email:user.email,currentPassword,newPassword}) }).then(function (res) {
                return res.json()
